...
/**
 * @covers \Kaspi\DiContainer\Exception\DiDefinitionException
 *
 * @internal
 */
class DiDefinitionExceptionTest extends TestCase
{
    public function testContextByIndex(): void
    {
        $e = (new DiDefinitionException(''))
    ...
    {
        $e = (new DiDefinitionException())->setContext(
            context_string: 'string',
            context_dto: ['foo', 'bar'],
            context_std_class: new stdClass()
        );
