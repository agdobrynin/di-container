...
trait StaticMethodDiDefinitionAutowireTrait
{
     ...
     */
    private static function invokeMethod(DiTaggedDefinitionAutowireInterface $definition, mixed $method, bool $requireMethod, string $where, array $supportReturnTypes = ['int', 'string', 'null'], mixed ...$args): mixed
    {
