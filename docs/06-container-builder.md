...
- [передача контекста для конфигурационных файлов](#передача-контекста-для-конфигурационных-файлов)
  - `DiContainerBuilder::addConfiguratorContexts()` – передача коллекции контекста.
  - `DiContainerBuilder::setConfiguratorContext()` – передача одиночного контекста.
