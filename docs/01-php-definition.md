...
> то нужно использовать функцию-хэлпер [diValue](#divalue---определение-аргумента-без-обработки--как-есть)._ 
...
> ];
> ```
##### diGet - определение аргумента как ссылки на другой идентификатор контейнера.
...
##### diValue - определение аргумента без обработки — «как есть».
...
функция-хэлпер [diGet](#diget---определение-аргумента-как-ссылки-на-другой-идентификатор-контейнера).
