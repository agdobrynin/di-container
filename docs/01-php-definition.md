...
> [!TIP]
> ✅ Для параметров методов php классов или `callable` выражений можно указывать [скалярные типы](https://www.php.net/manual/ru/language.types.type-system.php#language.types.type-system.atomic.scalar),
...
> или не требует дополнительной конфигурации.
