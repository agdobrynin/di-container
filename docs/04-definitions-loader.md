# 📂 DefinitionsLoader
Инструмент позволяет собирать все определения для контейнера зависимостей из разных конфигурационных файлов (_dependency definitions_).
Так же доступен "импорт" классов в контейнер из директорий и их конфигурирование на основе PHP атрибутов.

> [!WARNING]
> Инструмент **DefinitionsLoader** является внутренним.
...
зависимости класса](../README.md#%D0%BA%D0%BE%D0%BD%D1%84%D0%B8%D0%B3%D1%83%D1%80%D0%B8%D1%80%D0%BE%D0%B2%D0%B0%D0%BD%D0%B8%D0%B5-dicontainer)
