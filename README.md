...
```
> [!TIP]
> Больше информации о [методе `call()`](docs/03-call-method.md)
...
* 📦 [Метод контейнера `call()`](docs/03-call-method.md) для вызова чистых `callable` типов и дополнительных определений.
